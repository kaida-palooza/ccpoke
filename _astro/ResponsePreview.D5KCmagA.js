import{R as s,L as i,E as a,M as n,G as r}from"./MarkdownBody.bMX6E-AM.js";import{u as e}from"./jsxRuntime.module.kJjLVEAC.js";import{k as o}from"./preact.module.EGlgVV74.js";import"./hooks.module.BVG3ayJl.js";/* empty css                          */const c=`# So Sánh Các Platform Bot
...
Bạn muốn thêm bot cho platform nào? Mình có thể tạo plan để extend codebase Telegram hiện tại.`,l=[{status:"modified",file:"src/auth/middleware.ts"},{status:"modified",file:"src/auth/token-service.ts"},{status:"added",file:"src/auth/refresh-token.ts"},{status:"added",file:"src/auth/rate-limiter.ts"},{status:"modified",file:"src/routes/api.ts"},{status:"deleted",file:"src/auth/legacy-session.ts"},{status:"modified",file:"package.json"},{status:"renamed",file:"src/auth/index.ts"},{status:"added",file:"tests/auth/token.test.ts"},{status:"added",file:"tests/auth/flow.test.ts"},{status:"modified",file:"src/config/env.ts"}];function f(){const t=new URLSearchParams(window.location.search).get("mode")??"success";return e("div",{class:"rv",children:e("main",{class:"rv__body",children:[e(s,{project:"claudecode-tele",timestamp:"2026-02-21T12:44:19.009Z",model:"claude-sonnet-4-10"}),t==="loading"&&e(i,{}),t==="error"&&e(a,{message:"Dữ liệu response đã hết hạn. Thông tin cơ bản hiển thị ở trên."}),t==="success"&&e(o,{children:[e(n,{content:c}),e(r,{changes:l,locale:"en"})]})]})})}export{f as default};
